(function () {
	...
	var anObject$f = function (argument) {
	  ...
	  throw new $TypeError$b($String$1(argument) + ' is not an object');
	};
	...
	Function.prototype.toString = makeBuiltIn$2(function toString() {
	  return isCallable$8(this) && getInternalState(this).source || inspectSource(this);
	}, 'toString');
	...
	*/
	...
	var FORCED$1 = DESCRIPTORS$3 && fails$5(function () {
	...
	var NativeIterator = global$6[ITERATOR$2];
	...
	if (!hasOwn$1(IteratorPrototype$1, TO_STRING_TAG$3)) defineIteratorPrototypeAccessor(TO_STRING_TAG$3, ITERATOR$2);
	...
	var getIterator$1 = function (argument, usingIterator) {
	  ...
	  if (aCallable$5(iteratorMethod)) return anObject$5(call$5(iteratorMethod, argument));
	...
	$({ global: true, bind: true, enumerable: true, forced: global$1.setImmediate !== setImmediate }, {
