...
const AccordionContext = context$1;
...
const AccordionItemContext = context;
...
const Badge = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ref,
    ...props,
    className: classNames(className, prefix, pill && "rounded-pill", text && "text-".concat(text), bg2 && "bg-".concat(bg2))
  });
});
...
function useCol({
  ...
  breakpoints.forEach((brkPoint) => {
    ...
    if (span)
      spans.push(span === true ? "".concat(bsPrefix).concat(infix) : "".concat(bsPrefix).concat(infix, "-").concat(span));
    if (order != null)
      classes.push("order".concat(infix, "-").concat(order));
    if (offset != null)
      classes.push("offset".concat(infix, "-").concat(offset));
  });
  return [{
    ...props,
...
const Row = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  breakpoints.forEach((brkPoint) => {
    ...
    const infix = brkPoint !== minBreakpoint ? "-".concat(brkPoint) : "";
    if (cols != null)
      classes.push("".concat(sizePrefix).concat(infix, "-").concat(cols));
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ref,
    ...props,
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Row$1, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Col$1, { sm: "6", md: "3", children: [
      "DRAGONBALL",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion$1, { defaultActiveKey: "0", children: data.map((it, ix) => {
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion$1.Item, { eventKey: "".concat(ix), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion$1.Header, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge$1, { children: it.capitulos.length }),
            it.title
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion$1.Body, { className: "scrolling-body", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Table$1, { variant: "striped", children: /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: it.capitulos.map((it2, ix2) => {
            const className = it2.nro === focus.nro ? "bg-warning text-white" : "";
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge$1, { children: [
                "Cap: ",
                it2.nro
              ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Col$1, { sm: "6", md: "9", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge$1, { children: focus.nro }),
        " ",
        focus.titulo
      ] }),
